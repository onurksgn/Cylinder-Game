...
public class MarketItem : MonoBehaviour
{
    ...
    public bool HasItem()
    {
        ...
        // 1 : satýn alýnmýþ giyilmemiþ
        // 2 : satýn alýnmýs giyilmiþ
    ...
    } // satýn alma fonksiyonu
    public void Equipýtem()
    {
        UnequipItem();
    ...
    public void UnequipItem()
    {
        ...
        {
            MarketItem marketItem = MarketController.Current.items[equippedItem.itemId]; // market controllerdaký tum eþyalara eriþyoruz .  giyili olan eþyanýn ID sine karþýlýk gelene market Id objesini bana ver.
